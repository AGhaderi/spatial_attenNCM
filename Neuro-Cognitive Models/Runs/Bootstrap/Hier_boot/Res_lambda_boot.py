...
modelfile = '../../stans/res_lambda_modelt.stan' #reading the model span
f = open(modelfile, 'r')
model_wiener = f.read()
...
utils.to_pickle(stan_model=sm, stan_fit=fit, save_path="../../save/boot/"+str(run)+"/"+str(run)+"_res_lambda.pkl")
