...
modelfile = '../../stans/non-boot/n200lat_modelt.stan' #reading the model span
f = open(modelfile, 'r')
model_wiener = f.read()
...
for c in range(0, nchains):
    chaininit = {
        ...
        'lambdahier': np.random.uniform(.01, .02),        
        ...
        'lambda': np.random.uniform(.01, .02, size=(nparts)),
...
utils.to_pickle(stan_model=sm, stan_fit=fit, save_path='../../save/non-boot/n200lat_modelt.pkl')
