...
modelfile = '../../stans/non-boot/lambda_modelt.stan' #reading the model span
f = open(modelfile, 'r')
model_wiener = f.read()
...
utils.to_pickle(stan_model=sm, stan_fit=fit, save_path='../../save/non-boot/lambda_modelt.pkl')
