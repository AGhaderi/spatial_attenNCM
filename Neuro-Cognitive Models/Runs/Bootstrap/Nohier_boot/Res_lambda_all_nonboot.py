...
modelfile = '../../stans/non-boot/res_lambda_all.stan' #reading the model span
f = open(modelfile, 'r')
model_wiener = f.read()
...
utils.to_pickle(stan_model=sm, stan_fit=fit, save_path='../../save/non-boot/res_lambda_all.pkl')
