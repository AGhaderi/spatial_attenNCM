...
modelfile = '../../stans/sim/res_lambda_sim.stan' #reading the model span
f = open(modelfile, 'r')
model_wiener = f.read()
...
for c in range(0, nchains):
    chaininit = {
        ...
        'lambda': np.random.uniform(.1, .2, size=nspats),
...
utils.to_pickle(stan_model=sm, stan_fit=fit, save_path='../../save/sim/sim3_res_lambda.pkl')
